...
namespace Abc.Sql.MvcWebUI.Controllers
{
    public class CartController : Controller
    {
        ...
        public IActionResult AddToCart(int productId)
        {
            ...
            TempData.Add("message", String.Format("Your product {0},was succesfully added to the chart!", productToBeAdded.ProductName));
        ...
        {
            var shippingDetaillsViewModel = new ShippingDetailsViewModel
            {
                ShippingDetails = new ShippingDetails()
            };
            return View(shippingDetaillsViewModel);
        }
        [HttpPost]
